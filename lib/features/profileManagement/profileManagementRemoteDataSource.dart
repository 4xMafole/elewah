...
import 'package:elewah/features/profileManagement/profileManagementException.dart';
...
class ProfileManagementRemoteDataSource {
  ...
  */
  ...
  /*response ********{"error":false,"message":"Profile uploaded successfully!","data":{profileKey:"http:\/\/elewah.thewrteam.in\/images\/profile\/1623326274.jpg"}}*/
  ...
  Future postApiFile(Uri url, Map<String, File?> fileList,
    ...
    try {
      ...
      for (var key in fileList.keys.toList()) {
        ...
        var pic1 = http.MultipartFile.fromBytes(
            key, fileList[key]!.readAsBytesSync(),
            filename: fileList[key]!.path,
