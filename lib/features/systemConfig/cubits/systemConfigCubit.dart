...
import 'package:elewah/features/systemConfig/model/supportedQuestionLanguage.dart';
import 'package:elewah/features/systemConfig/model/systemConfigModel.dart';
...
class SystemConfigCubit extends Cubit<SystemConfigState> {
  ...
  void getSystemConfig() async {
    ...
    try {
      ...
      if (systemConfig.languageMode == "1") {
        supporatedLanguages = await _systemConfigRepository
            .getSupportedQuestionLanguages() as List<SupportedLanguage>;
      }
  ...
  SystemConfigModel getSystemDetails() {
    ...
    return SystemConfigModel.fromMap({});
  }
