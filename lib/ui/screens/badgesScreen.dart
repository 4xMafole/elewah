...
import 'package:elewah/ui/widgets/badgesIconContainer.dart';
...
class _BadgesScreenState extends State<BadgesScreen> {
  ...
  void showBadgeDetails(BuildContext context, badge.Badge badge) {
  ...
  List<badge.Badge> _organizedBadges(List<badge.Badge> badges) {
    List<badge.Badge> lockedBadges =
        badges.where((element) => element.status == "0").toList();
    List<badge.Badge> unlockedBadges = badges
